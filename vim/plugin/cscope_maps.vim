...
if has("cscope")
    ...
    elseif $CSCOPE_DB != ""
        ...
        let s:Branch = system('syno.common -q get_branch')
	if '' != s:Branch && '' != $HOME && filereadable($HOME.'/tags/'.s:Branch.'/cscope.out')
		let $CSCOPE_DB = $HOME.'/tags/'.s:Branch
	elseif '' != s:Branch && filereadable('/synosrc/'.s:Branch.'/tags/cscope.out')
		let $CSCOPE_DB = '/synosrc/'.s:Branch.'/tags'
	endif
	if '' != $CSCOPE_DB
		cs add $CSCOPE_DB
	endif
